...
if(isset($_POST['sreq_id'])){
    ...
    $query = "SELECT * FROM service_request WHERE sreq_id = '".$_POST['sreq_id']."'";
...
if(isset($_POST['submit'])) {
    ...
    $query = "UPDATE service_request SET tech_id = '$techId', date_completed = '$completed', status = '$status' WHERE sreq_id = '$id'";
