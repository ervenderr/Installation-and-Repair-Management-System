        ...
        ?>
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">List of Online Customer</h4>
                                            ...
                                            <tbody>
                                                ...
                                                if(!isset($_GET['keyword'])){
                                                    ...
                                                    $query = "SELECT customer.cust_id, customer.fname, customer.lname, customer.phone, customer.address, customer.cust_type, accounts.email, accounts.user_type
                                                        ...
                                                        WHERE customer.cust_type = 'online'
                                                    ...
                                                    $query = "SELECT customer.cust_id, customer.fname, customer.lname, customer.phone, customer.address, customer.cust_type, accounts.email, accounts.user_type
                                                                ...
                                                                WHERE (accounts.email LIKE '%$keyword%' AND customer.cust_type = 'online' AND accounts.user_type = 'customer'
                                                                OR customer.fname LIKE '%$keyword%' AND customer.cust_type = 'online' AND accounts.user_type = 'customer'
                                                                OR customer.lname LIKE '%$keyword%' AND customer.cust_type = 'online' AND accounts.user_type = 'customer'
                                                                )";
