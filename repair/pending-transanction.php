                ...
                <div class="col-sm-9 accform ">
                    <nav class="nav nav-pills flex-column flex-sm-row">
                        <a class="flex-sm-fill text-sm-center nav-link active" aria-current="page"
                            href="pending-transaction.php">Pending</a>
                        <a class="flex-sm-fill text-sm-center nav-link" href="repairing-transaction.php">Repairing</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="text-start">
                                        <form method="post" action="../repair-invoice/booking-repair-pdf.php"
                                            target="_blank">
                                            <button type="submit" name="download" value="<?php echo $row['id']; ?>" class="btn btn-secondary">Download
