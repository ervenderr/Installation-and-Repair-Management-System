...
$sql = "SELECT customer.cust_id, customer.account_id, customer.fname, customer.mname, customer.lname, customer.phone, customer.address, accounts.account_id, accounts.email, accounts.password, accounts.user_type, accounts.created_at, accounts.updated_at, rprq.id, rprq.cust_id, rprq.transaction_code, rprq.etype, rprq.defective, rprq.shipping, rprq.image, rprq.date_req, rprq.date_completed FROM customer, accounts, rprq WHERE rprq.cust_id=customer.cust_id AND customer.account_id=accounts.account_id AND accounts.account_id='{$user_id}'";
