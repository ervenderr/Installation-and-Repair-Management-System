            ...
            <div class="row">
                ...
                <div class="col-sm-9 accform ">
                    <nav class="nav nav-pills flex-column flex-sm-row">
                        ...
                        <a class="flex-sm-fill text-sm-center nav-link active" href="pickup-transaction.php">Underway
                            <?php
                    ...
                    LEFT JOIN customer ON service_request.cust_id = customer.cust_id
                    LEFT JOIN accounts ON customer.account_id = accounts.account_id
                    WHERE service_request.status = 'Underway' AND accounts.account_id = '{$user_id}';";
                    $result = mysqli_query($conn, $query);
