                                            ...
                                            <tbody>
                                                ...
                                                if(!isset($_GET['keyword'])){
                                                    ...
                                                    $query = "SELECT rprq.id, rprq.transaction_code, customer.fname, customer.lname, rprq.status, rprq.date_req
                                                                FROM rprq
                                                                JOIN customer ON rprq.Cust_id = customer.Cust_id
                                                                WHERE (rprq.transaction_code LIKE '%$keyword%' AND rprq.status = 'Pending'
                                                                OR customer.fname LIKE '%$keyword%' AND rprq.status = 'Pending'
                                                                OR customer.lname LIKE '%$keyword%' AND rprq.status = 'Pending'
                                                                )";
